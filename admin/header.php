            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="index.php"><img class="brand-logo" alt="modern admin logo" src="../assets/uploads/settings/<?=$logo?>">
                            <h3 class="brand-text">Sistema de Gestion y Control de Farmacia</h3>
                        </a></li>
            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        ?></span></a>
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="account.php"><i class="ft-user"></i> Edit Profile</a>
    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-dark navbar-without-dd-arrow navbar-shadow" role="navigation" data-menu="menu-wrapper">
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="pos.php"><i class="la la-money"></i><span>POS</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="sales.php"><i class="la la-rupee"></i><span>Ventas</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="categories.php"><i class="la la-tags"></i><span>Categorias</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="suppliers.php"><i class="la la-truck"></i><span>Proveedores</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="customers.php"><i class="la la-users"></i><span>Clientes</span></a>
                </li>
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="users.php"><i class="la la-user-plus"></i><span>Usuarios</span></a>
                </li>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="" data-toggle="dropdown"><i class="la la-medkit"></i><span>Reportes</span></a>
                    <ul class="dropdown-menu">
                        <li data-menu=""><a class="dropdown-item" href="sales_report.php" data-toggle=""><i class="la la-edit"></i><span>Sales Report</span></a>
                        </li>
                ...
                <li class="nav-item"><a class="dropdown-toggle nav-link" href="settings.php"><i class="la la-cogs"></i><span>Config</span></a>
                </li>
                <?php } ?>
