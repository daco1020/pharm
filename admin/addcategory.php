                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                         ?>
                                             <form class="form-horizontal" action="app/categories.php" method="post" enctype="multipart/form-data" novalidate>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    ...
                                                    <div class="text-right">
                                                        ...
                                                        <a href="categories.php" class="btn btn-danger">Cancel <i class="la la-close position-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
